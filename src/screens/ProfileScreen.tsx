...
export default function ProfileScreen({ navigation, theme }: any) {
  ...
  const accountAvatar = require('../../assets/avatars/otter-avatar-calm.png');
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <View style={[styles.profileCard, { backgroundColor: colors.surfaceContainerLow }]}>
          <View style={[styles.avatarLarge, { backgroundColor: colors.primaryContainer + '33' }]}>
            <Image source={accountAvatar} style={styles.avatarImage} accessibilityIgnoresInvertColors />
          </View>
...
const styles = StyleSheet.create({
  ...
  topBarTitle: { fontSize: sc(16), fontWeight: '800', letterSpacing: 0 },
  ...
  avatarLarge: { width: sc(78), height: sc(78), borderRadius: sc(39), alignItems: 'center', justifyContent: 'center', marginBottom: sc(12), overflow: 'hidden' },
  avatarImage: { width: sc(88), height: sc(88), resizeMode: 'contain', marginTop: sc(12) },
